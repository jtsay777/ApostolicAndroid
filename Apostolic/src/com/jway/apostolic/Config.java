...
public class Config {
    ...
    private static final String LOCAL_CONFIG_CLASS_NAME = "com.cyrilmottier.android.polarissample.util.Config";//"com.cyrilmottier.android.polarissample.util.LocalConfig";
    private static final String LOCAL_GOOGLE_MAPS_API_KEY_RELEASE_FIELD_NAME = "0rsx4mjCOwST_IekqR4Ce-fs4RuhxMsN7w8K5Fg";//"GOOGLE_MAPS_API_KEY_RELEASE";
    private static final String LOCAL_GOOGLE_MAPS_API_KEY_DEBUG_FIELD_NAME = "0rsx4mjCOwSSc-Qsif-Nf6IDvORdUYYRZNNF1HQ";//"GOOGLE_MAPS_API_KEY_DEBUG";
    ...
    private static String getLocalConfigString(String name) {
        try {
            ...
            //return (String) getLocalConfig().getField(name).get(null);
        	//return LOCAL_GOOGLE_MAPS_API_KEY_DEBUG_FIELD_NAME;
